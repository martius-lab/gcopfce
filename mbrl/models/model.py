...
class Ensemble(Model, abc.ABC):
    ...
    def sample_1d(
    ...
    ) -> Tuple[torch.Tensor, Optional[Dict[str, torch.Tensor]], Optional[Tuple[torch.Tensor, torch.Tensor]]]:
        ...
        # TODO: the next line breaks determinism across machines. The rng changes its state
        # different locally wrt the cluster. Currently no solution.
        if return_distributions:
            return torch.normal(means, stds, generator=rng), model_state, means, stds    
